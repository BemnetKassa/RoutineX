...
export default function ReadingRoutineScreen({ navigation }: any) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Reading session</Text>
      <Text style={styles.subheading}>Make space for a calm reading habit.</Text>

      <Text style={styles.label}>Title</Text>
      <TextInput
        placeholder="Reading session"
        onChangeText={setTitle}
        value={title}
        style={styles.input}
      />

      <Text style={styles.label}>Book or topic</Text>
      <TextInput
