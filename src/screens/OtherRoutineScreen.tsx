...
export default function OtherRoutineScreen({ navigation }: any) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.heading}>Other routines</Text>
      <Text style={styles.subheading}>Define a routine that matters to you.</Text>
